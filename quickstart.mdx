---
title: 'Quickstart'
description: 'Learn to locally setup MyShare for yourself and learn how to use the API!'
---
...
<AccordionGroup>
  <Accordion icon="github" title="Clone the MyShare repository">
   To get started, first clone the repo by doing `git clone https://github.com/MySharee/MyShare.git`
  </Accordion>
